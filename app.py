...
if not camera.isOpened():
    raise RuntimeError("Could not open camera. Check camera index (0 or 1).")
...
def generate_frames():
    ...
    while True:
        ...
        if len(frame.shape) == 2:
            ...
            continue  # Skip frames with unexpected channels
        ...
        direction_text = ""
        frame_center = frame.shape[1] // 2  # Middle X
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            # Calculate direction for UNKNOWN faces
            if name == "Unknown":
